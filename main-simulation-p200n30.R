...
#------------------------------------
#------------------------------------
pdf(file = "box31r.pdf",width=14,height=7)
...
dev.off()
#------------------------------------
pdf(file = "box32r.pdf",width=14,height=7)
...
dev.off()
#------------------------------------
pdf(file = "box33r.pdf",width=14,height=7)
...
dev.off()
#------------------------------------
pdf(file = "box34r.pdf",width=14,height=7)
...
dev.off()
#------------------------------------
pdf(file = "box35r.pdf",width=14,height=7)
...
dev.off()
#------------------------------------
pdf(file = "box36r.pdf",width=14,height=7)
